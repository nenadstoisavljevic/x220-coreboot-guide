# Flashing Coreboot on the ThinkPad X220
...
Carefully wire up the Pomona 5250 clip to the Raspberry Pi by using female to female jumper wires. For the pinout instructions, just visit [my website](https://nenadstoisavljevic.xyz/articles/coreboot) and everything is there.
