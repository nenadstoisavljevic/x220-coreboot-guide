...
Carefully wire up the Pomona 5250 clip to the Raspberry Pi by using female to female jumper wires. For the pinout instructions, just visit [my website](https://stoisavljevic.com/articles/coreboot) and everything is there.
